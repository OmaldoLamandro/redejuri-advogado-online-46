  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "Precisava de orientação urgente sobre minha demissão. Em 10 minutos a plataforma me conectou com uma advogada especialista que me ajudou a entender todos os meus direitos. Valeu cada centavo dos R$50!",
      initials: "MS"
    },
    {
      name: "João Santos",
    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6">
            ...
            <Card key={index} className="group hover:shadow-elegant transition-all duration-300 hover:scale-105">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center mb-3 sm:mb-4">
                  <Avatar className="mr-3 sm:mr-4 w-10 h-10 sm:w-12 sm:h-12">
        ...
        <div className="text-center">
          <div className="bg-card border rounded-2xl p-6 sm:p-8 max-w-4xl mx-auto shadow-md">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-center">
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-primary mb-1 sm:mb-2">10.000+</h3>
                <p className="text-sm sm:text-base text-muted-foreground">Conexões Realizadas</p>
              </div>
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-primary mb-1 sm:mb-2">4.9★</h3>
                <p className="text-sm sm:text-base text-muted-foreground">Avaliação Média</p>
              </div>
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-primary mb-1 sm:mb-2">2 min</h3>
                <p className="text-sm sm:text-base text-muted-foreground">Tempo Médio de Espera</p>
              </div>
            </div>
          </div>
        </div>
